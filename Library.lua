...
local Library = {
    ...
    AccentColor = Color3.fromRGB(254, 1, 154);
...
function Library:CreateWindow(...)
    ...
    local GlowOutline = Library:Create('Frame', {
        ...
        BorderSizePixel = 0;
        Position = UDim2.new(-0.005, 0, -0.005, 0);
    ...
    Library:AddToRegistry(GlowOutline, {
        BackgroundColor3 = 'AccentColor';
    });

    local OuterGlow = Library:Create('Frame', {
        BackgroundColor3 = Library.AccentColor;
        BackgroundTransparency = 0.9;
        BorderSizePixel = 0;
        Position = UDim2.new(-0.008, 0, -0.008, 0);
        Size = UDim2.new(1.016, 0, 1.016, 0);
        ZIndex = -1;
        Parent = Outer;
    });
    ...
    function Window:AddTab(Name)
        ...
        local TabButton = Library:Create('Frame', {
            BackgroundColor3 = Library.BackgroundColor;
            BorderColor3 = Library.OutlineColor;
            Size = UDim2.new(0, TabButtonWidth, 0, 25);
            ZIndex = 3;
            Parent = TabArea;
        });
